...
class NotificationAppointments extends Command
{
    ...
    public function handle()
    {
        ...
        $simulet_hour_number = date("2023-11-24 9:36:35");//strtotime(date("2023-10-24 09:35:35"));
        $appointments = Appointment::whereDate("date_appointment","2023-11-24")//now()->format("Y-m-d")
                                    ->where("status",1) 
                                    ->get();
        ...
        foreach ($appointments as $key => $appointment) {
            ...
            error_log($appointment->patient->email);
        }
